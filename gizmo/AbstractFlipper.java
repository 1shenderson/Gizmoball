...
public class AbstractFlipper extends AbstractGizmo {
	...
	public List<LineSegment> getSides() {
		...
		LineSegment newls = new LineSegment(x+6.25, y+6.25, x2+6.25,y2);
		lineList.add(newls);
		LineSegment newls2 = new LineSegment(x-6.25, y-6.25, x2-6.25,y2);
		lineList.add(newls2);
		return lineList;
	}
	...
	public List<Circle> getCorners() {
		...
		Circle circle = new Circle(x-6,y-6,12);
		circleList.add(circle);
		Circle circle2 = new Circle(x2-6,y2-6,12);
